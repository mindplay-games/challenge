...

{
  ...
  explain:
    "פונקציה היא כמו כפתור שמפעיל פעולה. לפעמים הכפתור צריך מידע כדי לעבוד.\n" +
    "המידע הזה נכנס לסוגריים ונקרא פרמטר.\n" +
    "פרמטר הוא כמו 'קופסה ריקה' בתוך הפונקציה. כשקוראים לפונקציה, שולחים לקופסה ערך.\n\n" +
    "דוגמה:\n" +
    "def greet(name):  ← name זה הפרמטר (קופסה)\n" +
    "greet('דנה')     ← 'דנה' זה הערך שנשלח (מה שמכניסים לקופסה)\n",
  task:
    "1) כתבו פונקציה בשם greet שמקבלת פרמטר בשם name.\n" +
    "2) בתוך הפונקציה הדפיסו: שלום + השם שקיבלתם.\n" +
    "3) עכשיו קראו לפונקציה פעמיים:\n" +
    "   - פעם אחת עם השם שלכם\n" +
    "   - ופעם אחת עם שם של חבר/ה\n",
  hint:
    "זכרו:\n" +
